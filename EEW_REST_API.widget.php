 ...
 *
 * EEW_REST_API
 * Displays a List of REST_API in the Sidebar
 *
 * @package			Event Espresso
 ...
 * ------------------------------------------------------------------------
 */
class EEW_REST_API extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'ee-rest_api-widget',
			__( 'Event Espresso REST_API Widget', 'event_espresso' ),
			 array(
			 	'description' => __( 'Displays Espresso REST_API in a widget.', 'event_espresso' )
			 ),
			array(
				'width' => 300,
				'height' => 350,
				'id_base' => 'ee-rest_api-widget'
			)
		);
	}
...
<?php
	...
	public function widget( $args, $instance ) {
		...
		if ( isset( $post->post_content )) {
			 ...
			 if ( strpos( $post->post_content, '[ESPRESSO_REST_API') === FALSE ) {
				 EED_REST_API::$shortcode_active = TRUE;
				...
				// load scripts
				EE_REST_API::instance()->enqueue_scripts();
				// settings
				$attributes = array();
				echo EE_REST_API::instance()->display_rest_api( $attributes );
...
// End of file EEW_REST_API.widget.php
// Location: /wp-content/plugins/eea-rest-api/EEW_REST_API.widget.php